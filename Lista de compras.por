programa {
  funcao inicio() {
    cadeia limpeza[20], higiene[20], frutas[20], verduras[20], cerais[20]
    ...
    enquanto (saida != 0) {
      ...
      escreva("5)Adicione um item de cereais\n")
      escreva("6)Mostre a lista.\n")
      escreva("7)Fim da lista.\n")
      escreva("Escolha ua opção:")
      ...
      escolha(opcao){
        ...
        caso 7:
        limpa()
        escreva("Lista completa, Obrigado!")
        saida = 0
        pare
